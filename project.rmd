...
#### 4. Indie games are cheaper in general
...
#### 6. Developer with the most positive reviews
...
#### 7. Testing price for single-player, mmulti-player
...
#### 8. Multi-player games are more expensive then Single-player
